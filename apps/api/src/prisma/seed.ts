  ...
  const categoriesData = [
    {
      ...
      imageUrl: 'https://images.unsplash.com/photo-1521572267360-ee0c2909d518?q=80&w=800&auto=format&fit=crop&fm=webp',
      displayOrder: 1,
    },
    {
      name: 'Outerwear',
      ...
      imageUrl: 'https://images.unsplash.com/photo-1544441893-675973e31985?q=80&w=800&auto=format&fit=crop&fm=webp',
      displayOrder: 2,
    },
    {
      name: 'Bottoms',
      ...
      imageUrl: 'https://images.unsplash.com/photo-1541099649105-f69ad21f3246?q=80&w=800&auto=format&fit=crop&fm=webp',
      displayOrder: 3,
    },
    {
      name: 'Accessories',
      ...
      imageUrl: 'https://images.unsplash.com/photo-1523779917675-b6ed3a42a561?q=80&w=800&auto=format&fit=crop&fm=webp',
      displayOrder: 4,
    },
  ];
  ...
  const collectionsData = [
    {
      ...
      bannerImageUrl: 'https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop&fm=webp',
    },
    {
      name: 'Minimalist Essentials',
      slug: 'minimalist-essentials',
      description: 'Timeless wardrobe staples built for everyday versatility',
      bannerImageUrl: 'https://images.unsplash.com/photo-1490481651871-ab68de25d43d?q=80&w=1200&auto=format&fit=crop&fm=webp',
    },
  ];
  ...
  if (existingBanners === 0) {
    await prisma.banner.create({
      data: {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1490481651871-ab68de25d43d?q=80&w=1600&auto=format&fit=crop&fm=webp',
  ...
  const sampleProducts = [
    {
      ...
      images: [
        'https://images.unsplash.com/photo-1596755094514-f87e34085b2c?q=80&w=800&auto=format&fit=crop&fm=webp',
        'https://images.unsplash.com/photo-1598033129183-c4f50c736f10?q=80&w=800&auto=format&fit=crop&fm=webp',
      ],
      vars: [
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?q=80&w=800&auto=format&fit=crop&fm=webp'],
      vars: [
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?q=80&w=800&auto=format&fit=crop&fm=webp'],
      vars: [
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1521572267360-ee0c2909d518?q=80&w=800&auto=format&fit=crop&fm=webp'],
      vars: [
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1576995853123-5a10305d93c0?q=80&w=800&auto=format&fit=crop&fm=webp'],
      vars: [
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?q=80&w=800&auto=format&fit=crop&fm=webp'],
      vars: [
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1618354691373-d851c5c3a990?q=80&w=800&auto=format&fit=crop&fm=webp'],
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?q=80&w=800&auto=format&fit=crop&fm=webp'],
      vars: [
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1591047139829-d91aecb6caea?q=80&w=800&auto=format&fit=crop&fm=webp'],
      vars: [
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1596755094514-f87e34085b2c?q=80&w=800&auto=format&fit=crop&fm=webp'],
...

    {
      ...
      images: [
        'https://images.unsplash.com/photo-1548883354-7622d03aca27?q=80&w=800&auto=format&fit=crop&fm=webp',
        'https://images.unsplash.com/photo-1591047139829-d91aecb6caea?q=80&w=800&auto=format&fit=crop&fm=webp',
      ],
      vars: [
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1544441893-675973e31985?q=80&w=800&auto=format&fit=crop&fm=webp'],
      vars: [
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1551028719-00167b16eac5?q=80&w=800&auto=format&fit=crop&fm=webp'],
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1539109136881-3be0616acf4b?q=80&w=800&auto=format&fit=crop&fm=webp'],
      vars: [
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1548883354-7622d03aca27?q=80&w=800&auto=format&fit=crop&fm=webp'],
...

    {
      ...
      images: [
        'https://images.unsplash.com/photo-1509631179647-0177331693ae?q=80&w=800&auto=format&fit=crop&fm=webp',
        'https://images.unsplash.com/photo-1541099649105-f69ad21f3246?q=80&w=800&auto=format&fit=crop&fm=webp',
      ],
      vars: [
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1541099649105-f69ad21f3246?q=80&w=800&auto=format&fit=crop&fm=webp'],
      vars: [
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1583496661160-fb5886a0aaaa?q=80&w=800&auto=format&fit=crop&fm=webp'],
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1509631179647-0177331693ae?q=80&w=800&auto=format&fit=crop&fm=webp'],
...

    {
      ...
      images: [
        'https://images.unsplash.com/photo-1590874103328-eac38a683ce7?q=80&w=800&auto=format&fit=crop&fm=webp',
        'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?q=80&w=800&auto=format&fit=crop&fm=webp',
      ],
      vars: [
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1548036328-c9fa89d128fa?q=80&w=800&auto=format&fit=crop&fm=webp'],
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?q=80&w=800&auto=format&fit=crop&fm=webp'],
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1523779917675-b6ed3a42a561?q=80&w=800&auto=format&fit=crop&fm=webp'],
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1624222247344-550fb60583dc?q=80&w=800&auto=format&fit=crop&fm=webp'],
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1511499767150-a48a237f0083?q=80&w=800&auto=format&fit=crop&fm=webp'],
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1601924994987-69e26d50dc26?q=80&w=800&auto=format&fit=crop&fm=webp'],
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1553062407-98eeb64c6a62?q=80&w=800&auto=format&fit=crop&fm=webp'],
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1635767798638-3e25273a8236?q=80&w=800&auto=format&fit=crop&fm=webp'],
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1627123424574-724758594e93?q=80&w=800&auto=format&fit=crop&fm=webp'],
    ...
    },
    {
      ...
      images: ['https://images.unsplash.com/photo-1543163521-1bf539c55dd2?q=80&w=800&auto=format&fit=crop&fm=webp'],
